...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * * `\_PAGES\_` - Total number of main of data in the table
			 *
			 *  @type string
	...
	DataTable.ext = _ext = {
		 ...
		 * 2. `{int} main` The number of main in the table
		 *
		 ...
		 *    $.fn.dataTableExt.oPagination.current = function ( page, main ) {
