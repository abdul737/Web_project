        ...
        !function o(e, t, n) {
            ...
            1: [function (o, a, r) {
                ...
                var l, i, u, c, d = o("./modules/handle-dom"), f = o("./modules/utils"),
                    ...
                    y = s(v), b = o("./modules/default-params"), h = s(b), g = o("./modules/set-params"), w = s(g);
                r["default"] = u = c = function () {
                    ...
                    var t = (0, p.getModal)(), n = t.querySelector("button.confirm"),
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= $directory ?>sweetalert/sweetalert.css">


    <title>Not registered access</title>
</head>
<body>
<script src="<?= $directory ?>sweetalert/sweetalert.min.js"></script>
<SCRIPT type="text/javascript">
    swal({
            title: "ERROR 404",
            text: "Page doesn't exist or \nnot accessible!",
            type: "error",
        ...
        function (isConfirm) {
            if (isConfirm) {
                setTimeout(function () {
                    window.location.replace("http://codecraft.uz/");
                }, 1000);
            }
        });
</SCRIPT>
