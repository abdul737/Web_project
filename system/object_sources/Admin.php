...
class Admin extends User
{
    ...
    public function addInstructor(InstructorPanel $instructor)
    {
        throw new Exception("Not implemented yet");
    }

    public function assignGroup(Group $group, Course $course, InstructorPanel $instructor, array $instructors)
    {
        throw new Exception("not implemented yet");
    }

    public function acceptKid(StudentPanel $kid, Course $course)
    {
        throw new Exception("not implemented yet");
    }

    public function addRequest(StudentPanel $kid, Course $course)
    {
        throw new Exception("not implemented yet");
    }
}
